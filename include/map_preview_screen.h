...
bool8 MapHasPreviewScreen(mapsec_u16_t mapsec, u8 type);
bool32 ForestMapPreviewScreenIsRunning(void);
const struct MapPreviewScreen * GetDungeonMapPreviewScreenInfo(mapsec_u16_t mapsec);
bool32 MapHasPreviewScreen_HandleQLState2(mapsec_u16_t mapsec, u8 type);
void MapPreview_InitBgs(void);
void MapPreview_LoadGfx(mapsec_u16_t mapsec);
bool32 MapPreview_IsGfxLoadFinished(void);
void MapPreview_Unload(s32 windowId);
void MapPreview_StartForestTransition(mapsec_u16_t mapsec);
