...
#define FREE_MYSTERY_EVENT_BUFFERS          TRUE    // Frees up ramScript (1104 bytes). Freed for two-region flag/var arrays.
...
#define FREE_MYSTERY_GIFT                   TRUE    // Frees up Mystery Gift data (876 bytes). Freed for two-region flag/var arrays.
