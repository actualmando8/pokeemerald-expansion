...
#define I_EXP_SHARE_FLAG        FLAG_EXP_SHARE_ALL  // Always-on: set at new game start. All party Pokémon gain experience.
#define I_EXP_SHARE_ITEM        GEN_LATEST          // Key item behavior (Gen6+), though flag is always set so toggle is moot.
