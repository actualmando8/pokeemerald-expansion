...
// FRLG flags (offset to avoid conflict with Emerald flags)
#define FRLG_FLAG_OFFSET 0xA00
#include "constants/flags_frlg.h"

// Kanto badge aliases - placeholder, real definitions after SYSTEM_FLAGS below

// Undef shared names from FRLG that Emerald redefines
#undef DAILY_FLAGS_END
#undef DAILY_FLAGS_START
#undef FLAG_BADGE01_GET
#undef FLAG_BADGE02_GET
#undef FLAG_BADGE03_GET
#undef FLAG_BADGE04_GET
#undef FLAG_BADGE05_GET
#undef FLAG_BADGE06_GET
#undef FLAG_BADGE07_GET
#undef FLAG_BADGE08_GET
#undef FLAG_DEOXYS_ROCK_COMPLETE
#undef FLAG_DONT_TRANSITION_MUSIC
...
#undef FLAG_HIDE_DEOXYS
#undef FLAG_HIDE_HO_OH
#undef FLAG_HIDE_LUGIA
#undef FLAG_HIDE_MAP_NAME_POPUP
#undef FLAG_IS_CHAMPION
...
#undef FLAG_NURSE_UNION_ROOM_REMINDER
#undef FLAG_PENDING_DAYCARE_EGG
#undef FLAG_RECEIVED_AURORA_TICKET
#undef FLAG_RECEIVED_MYSTIC_TICKET
#undef FLAG_RECEIVED_OLD_SEA_MAP
#undef FLAG_SAFE_FOLLOWER_MOVEMENT
#undef FLAG_SET_WALL_CLOCK
#undef FLAG_SHOWN_AURORA_TICKET
#undef FLAG_SHOWN_BOX_WAS_FULL_MESSAGE
#undef FLAG_SHOWN_MYSTIC_TICKET
#undef FLAG_SPECIAL_FLAG_UNUSED_0x4003
#undef FLAG_SYS_B_DASH
#undef FLAG_SYS_CLOCK_SET
#undef FLAG_SYS_CRUISE_MODE
#undef FLAG_SYS_CTRL_OBJ_DELETE
#undef FLAG_SYS_ENC_DOWN_ITEM
#undef FLAG_SYS_ENC_UP_ITEM
#undef FLAG_SYS_GAME_CLEAR
#undef FLAG_SYS_MYSTERY_EVENT_ENABLE
#undef FLAG_SYS_MYSTERY_GIFT_ENABLE
#undef FLAG_SYS_NATIONAL_DEX
#undef FLAG_SYS_PC_LANETTE
#undef FLAG_SYS_POKEDEX_GET
#undef FLAG_SYS_POKEMON_GET
#undef FLAG_SYS_RESET_RTC_ENABLE
#undef FLAG_SYS_RIBBON_GET
#undef FLAG_SYS_SAFARI_MODE
#undef FLAG_SYS_USE_FLASH
#undef FLAG_SYS_USE_STRENGTH
#undef FLAG_UNUSED_0x4A7
#undef FLAG_UNUSED_0x4A8
#undef FLAG_UNUSED_0x4A9
#undef FLAG_UNUSED_0x4AA
#undef FLAG_UNUSED_0x4AB
#undef FLAG_UNUSED_0x4AC
#undef FLAG_UNUSED_0x4AD
#undef FLAG_UNUSED_0x4AE
#undef FLAG_UNUSED_0x4AF
#undef FLAG_WONDER_CARD_UNUSED_1
#undef FLAG_WONDER_CARD_UNUSED_10
#undef FLAG_WONDER_CARD_UNUSED_11
#undef FLAG_WONDER_CARD_UNUSED_12
#undef FLAG_WONDER_CARD_UNUSED_13
#undef FLAG_WONDER_CARD_UNUSED_14
#undef FLAG_WONDER_CARD_UNUSED_15
#undef FLAG_WONDER_CARD_UNUSED_16
#undef FLAG_WONDER_CARD_UNUSED_17
#undef FLAG_WONDER_CARD_UNUSED_2
#undef FLAG_WONDER_CARD_UNUSED_3
#undef FLAG_WONDER_CARD_UNUSED_4
#undef FLAG_WONDER_CARD_UNUSED_5
#undef FLAG_WONDER_CARD_UNUSED_6
#undef FLAG_WONDER_CARD_UNUSED_7
#undef FLAG_WONDER_CARD_UNUSED_8
#undef FLAG_WONDER_CARD_UNUSED_9
#undef NUM_BADGES
#undef NUM_DAILY_FLAGS
#undef NUM_SPECIAL_FLAGS
#undef NUM_WONDER_CARD_FLAGS
#undef SPECIAL_FLAGS_END
#undef SPECIAL_FLAGS_START
#undef TRAINER_FLAGS_END
#undef TRAINER_FLAGS_START
...
#define FLAG_HIDE_VERMILION_HOENN_TICKET_MAN 0x54  // Custom: hide the Hoenn Ticket NPC in Vermilion
#define FLAG_GOT_HOENN_TICKET                0x55  // Custom: player received Hoenn Ticket
...
#define FLAG_HIDE_SLATEPORT_MUSEUM_THUG      0x68  // Custom: hide Devon Goods thug after defeat
...
#define FLAG_HIDE_DEWFORD_CUSTOM_BRINEY    0xE9  // Custom: return Briney in Dewford (boat to Slateport)
...
#define FLAG_HIDE_ROUTE117_BLOCKER          0x1AA // Custom: NPC blocking Route 117 until Dewford badge
#define FLAG_HIDE_SLATEPORT_CUSTOM_BRINEY   0x1AB // Custom: Briney in south Slateport (boat to Dewford)
...
#define FLAG_HIDE_SLATEPORT_PORT_ATTENDANT  0x1DA // Custom: port attendant for Kanto ferry

#define FLAG_SHOWN_MYSTIC_TICKET             0x1DB
#define FLAG_DEFEATED_HO_OH                  0x1DC
#define FLAG_DEFEATED_LUGIA                  0x1DD

#define FLAG_HIDE_ROUTE118_BLOCKER           0x1DE // Custom: NPC blocking Route 118 until 5 Kanto + 5 Hoenn badges
#define FLAG_MET_PROF_BIRCH                  0x1DF // Custom: player met Birch as Kanto visitor
#define FLAG_DEFEATED_CELEBI                 0x1E0
...
#define FLAG_HIDE_CELEBI                                            0x264
#define FLAG_HIDE_REGIELEKI                                         0x265
#define FLAG_HIDE_REGIDRAGO                                         0x266
#define FLAG_HIDE_REGIGIGAS                                         0x267
#define FLAG_DEFEATED_SEVII_NOLAND           0x268
#define FLAG_DEFEATED_SEVII_GRETA            0x269
#define FLAG_DEFEATED_SEVII_TUCKER           0x26A
#define FLAG_DEFEATED_SEVII_SPENSER          0x26B
#define FLAG_DEFEATED_SEVII_ANABEL           0x26C
#define FLAG_DEFEATED_SEVII_LUCY             0x26D
#define FLAG_DEFEATED_SEVII_BRANDON          0x26E
#define FLAG_IS_KANTO_CHAMPION               0x26F // Custom: Kanto E4 beaten
#define FLAG_NAVEL_ROCK_COMPLETED            0x270 // Custom: Navel Rock event completed
#define FLAG_DEFEATED_JIRACHI               0x271 // Custom: Jirachi defeated/caught
#define FLAG_UNUSED_0x272  0x272 // Unused Flag (FLAG_DEFEATED_DEOXYS already at 0x1AC)
#define FLAG_UNUSED_0x273  0x273 // Unused Flag (FLAG_DEFEATED_MEW already at 0x1C7)
#define FLAG_DEFEATED_MEWTWO                0x274 // Custom: Mewtwo defeated/caught
#define FLAG_DEFEATED_SEVII_GIOVANNI        0x275 // Custom: Stronger Giovanni in Sevii
...
// Kanto badge flags (separate tracking from Hoenn badges)
#define FLAG_KANTO_BADGE01_GET                      (SYSTEM_FLAGS + 0x21) // Boulder (Brock)
#define FLAG_KANTO_BADGE02_GET                      (SYSTEM_FLAGS + 0x22) // Cascade (Misty)
#define FLAG_KANTO_BADGE03_GET                      (SYSTEM_FLAGS + 0x23) // Thunder (Lt. Surge)
#define FLAG_KANTO_BADGE04_GET                      (SYSTEM_FLAGS + 0x24) // Rainbow (Erika)
#define FLAG_KANTO_BADGE05_GET                      (SYSTEM_FLAGS + 0x25) // Soul (Koga)
#define FLAG_KANTO_BADGE06_GET                      (SYSTEM_FLAGS + 0x26) // Marsh (Sabrina)
#define FLAG_KANTO_BADGE07_GET                      (SYSTEM_FLAGS + 0x27) // Volcano (Blaine)
#define FLAG_KANTO_BADGE08_GET                      (SYSTEM_FLAGS + 0x2E) // Earth (Giovanni)
...
#define FLAG_SYS_REGIELEKI_PUZZLE_COMPLETED        (SYSTEM_FLAGS + 0x83)
...
// FRLG offset flags always exceed Emerald count (0xA00+0x900 > 0x960)
#define FLAGS_COUNT FRLG_FLAGS_COUNT
